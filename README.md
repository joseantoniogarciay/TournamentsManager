...
| Registry, Terraform y AWS                           | Decisiones históricas; sin implementación ni recursos previstos                                                                                         | [ADR-0128](docs/adr/0128-close-roadmap-after-k3s-and-cancel-aws-phase.md)                                                                                                                                                       |
...
| Framework y rendering del cliente                   | Aceptado                                                                                                                                                | [ADR-0015](docs/adr/0015-use-expo-router-and-continuous-native-generation.md), [ADR-0016](docs/adr/0016-use-client-side-web-rendering-initially.md), [ADR-0120](docs/adr/0120-index-public-home-without-indexing-app-routes.md) |

La [base técnica](docs/governance/TECHNICAL_BASELINE.md), el gate 0B y las fases
1, [2](docs/project/PHASE_2_RETROSPECTIVE.md),
[3](docs/project/PHASE_3_RETROSPECTIVE.md) y
[4](docs/project/PHASE_4_RETROSPECTIVE.md) están cerrados. El backend entrega el
...
y `dev`. K3s ya opera el runtime doméstico de `prod`, conforme a
[ADR-0111](docs/adr/0111-use-k3s-vm-for-home-production-runtime.md). La fase cloud
se canceló en [ADR-0128](docs/adr/0128-close-roadmap-after-k3s-and-cancel-aws-phase.md).
La v1 queda cerrada: toda capacidad posterior se tratará como un incremento de
producto independiente, con análisis, decisión explícita, ADR cuando alcance el
umbral de decisión y pruebas/documentación proporcionales al riesgo.
