...
var (
	...
	// ErrTournamentForbidden indicates that the account does not organize the league.
	ErrTournamentForbidden = errors.New("liga no autorizada")
	// ErrTournamentConflict indicates that the start transition is invalid.
	ErrTournamentConflict = errors.New("liga no se puede iniciar")
	// ErrTournamentCancellationConflict indicates that the league cannot be cancelled from its current state.
	ErrTournamentCancellationConflict = errors.New("liga no se puede cancelar")
	// ErrTournamentAdministratorConflict indicates that the requested administrator assignment is invalid.
	ErrTournamentAdministratorConflict = errors.New("administradora de liga inválida")
	// ErrTournamentOwnershipTransferConflict indicates that the requested ownership transfer is invalid.
	...
	// ErrTournamentCompletionConflict indicates that the league cannot be completed yet.
	ErrTournamentCompletionConflict = errors.New("liga no se puede finalizar")
)
...
type Match struct {
	...
	HomeSourceKind    SlotSourceKind `json:"homeSourceKind"`
	AwaySourceKind    SlotSourceKind `json:"awaySourceKind"`
	HomeSourceMatchID string         `json:"homeSourceMatchId,omitempty"`
	AwaySourceMatchID string         `json:"awaySourceMatchId,omitempty"`
...
type CreationRepository interface {
	...
	RecordResult(context.Context, string, string, string, MatchResultInput) (Tournament, error)
	Complete(context.Context, string, string) (Tournament, error)
...
func (s CreationService) Create(ctx context.Context, accountID string, input CreateInput) (Tournament, error) {
...
func (s CreationService) Start(ctx context.Context, accountID, leagueID string, input StartInput) (Tournament, error) {
	if input.Format == "" {
		input.Format = "league"
	}
...
func (s CreationService) Cancel(ctx context.Context, accountID, leagueID string) (Tournament, error) {
...
func (s CreationService) GetPublic(ctx context.Context, leagueID string) (Tournament, error) {
...
func CalculateStandings(league Tournament) []Standing { return calculateStandings(league) }
