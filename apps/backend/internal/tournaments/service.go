// Package tournaments contains related league collection queries.
package tournaments
...
var (
	...
	// ErrTournamentNotFound indicates a nonexistent or invisible league.
	ErrTournamentNotFound = errors.New("liga no disponible")
)
