...
- **Tipografía:** familia de sistema por plataforma; escala de 12 a 32 px y pesos
  de 400 a 700. Así se preserva legibilidad nativa sin dependencia externa. El
...
| RequestErrorCard   | error de red o genérico, reintento, reintentando          | Estado terminal de una carga sin contenido. Recibe el mensaje seguro ya clasificado y una acción localizada de reintento; sustituye al banner para no duplicar el aviso en una pantalla vacía.                                                                                                                                                                                                                                                                                                                                                                                                                            |
